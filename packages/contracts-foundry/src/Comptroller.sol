...
contract Comptroller is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getHypotheticalAccountLiquidityInternal(
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            // console.log("collateralFactor",vars.collateralFactor.mantissa);
            // console.log("exchangeRate",vars.exchangeRate.mantissa);
    ...
    function liquidateCalculateSeizeTokens(address cTokenBorrowed, address cTokenCollateral, uint actualRepayAmount) override external view returns (uint, uint) {
        ...
        //console.log(exchangeRateMantissa); //400_000_000e18
        uint seizeTokens;
        ...
        //console.log("seizeTokensseizeTokens",seizeTokens);   
    ...
    function flashLoan(IERC3156FlashBorrower receiver,address token,uint256 amount,bytes calldata data) external returns(bool) {
        ...
        require(IERC20(token).transferFrom(address(receiver), address(this), amount),"FlashLender: Repay failed");
        return true;
    }
